...
if($_POST){
    ...
    if(empty($nama_siswa)){
        echo "<script>alert('nama siswa tidak boleh kosong');location.href='register.php';</script>";
        ...
        $insert=mysqli_query($conn,"insert into siswa (nama_siswa,tgl_lahir, gender, alamat, username, password, id_kelas) value ('".$nama_siswa."','".$tgl_lahir."','".$gender."','".$alamat."','".$username."','".md5($password)."','".$id_kelas."')") or die(mysqli_error($conn));
        if($insert){
