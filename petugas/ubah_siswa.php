...
<div class="container">
    <div class="row content">
        <div class="col-md-6 mb-3">
            <img src="../foto_buku/tambah_siswa-01.png" class="image-fluid" alt="image" width="100%" height="100%"/>
        </div>
        <div class="col-md-6">
            ...
            <form action="proses_ubah_siswa.php" method="POST">
                ...
                <div class="row g-3 mb-2">
                    ...
                    <div class="col-md">
                        ...
                        <input type = "date" name="tanggal_lahir" value="<?=$dt_siswa ['tgl_lahir'] ?>" class="form-control form" required>
                    </div>
                </div>
                <div class="row g-3 mb-2">
                    <!-- gender -->
