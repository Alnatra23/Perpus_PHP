...
global $conn;
$qry_get_pinjam=mysqli_query($conn, "select * from peminjaman_buku where id_peminjaman_buku ='".$_GET['id_peminjaman_buku']."'");
...
<div class="container">
    <div class="row content">
        <div class="col-md-6 mb-3">
            <img src="../foto_buku/peminjaman_buku-01.png" class="image-fluid" alt="image" width="100%" height="100%"/>
        </div>
        <div class="col-md-6">
            ...
            <form action="proses_ubah_peminjaman.php" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="date" name="tanggal_pinjam" value="<?=$dt_pinjam ['tgl_pinjam'] ?>" class="form-control form" >
                    </div>
                    <!-- Tanggal Kembali -->
                    <div class="mb-2">
                        <label class="form-label">Tanggal Kembali :</label>
                        <input type="date" name="tanggal_kembali" value="<?=$dt_pinjam ['tgl_kembali'] ?>" class="form-control form" >
                    </div>
                </div>
