...
<div class="container">
    <div class="row content">
        <div class="col-md-6 mb-3">
            <img src="../foto_buku/tambah_kelas-01.png" class="image-fluid" alt="image" width="100%" height="100%"/>
        </div>
        <div class="col-md-6">
            ...
            <form method="POST" action="proses_ubah_kelas.php">
                ...
                <input type = "submit" name ="simpan" value ="Ubah Kelas" class = "btn btn-primary   mb-2">
            </form>
        </div>
    </div>
