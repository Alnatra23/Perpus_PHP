...
if ($_POST) {
    ...
    if(empty($id_peminjaman_buku)){
        ...
        $update= mysqli_query ($conn, "update detail_peminjaman_buku set id_detail_peminjaman_buku='".$id_detail_peminjaman_buku."', id_peminjaman_buku='".$id_peminjaman_buku."', id_buku='".$id_buku."', qty='".$qty."' where id_detail_peminjaman_buku='".$id_detail_peminjaman_buku."' ") or die (mysqli_error($conn));
        if ($update) {
