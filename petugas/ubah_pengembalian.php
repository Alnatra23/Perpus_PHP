...
global $conn;
$qry_get_pengembalian=mysqli_query($conn, "select * from pengembalian_buku where id_pengembalian_buku ='".$_GET['id_pengembalian_buku']."'");
...
<div class="container">
    <div class="row content">
        <div class="col-md-6 mb-3">
            <img src="../foto_buku/pengembalian_buku-01.png" class="image-fluid" alt="image" width="100%" height="100%"/>
        </div>
        <div class="col-md-6">
            ...
            <form action="proses_ubah_pengembalian.php" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="date" name="tgl_kembali" value="<?=$dt_pengembalian ['tgl_kembali'] ?>" class="form-control form" required>
                    </div>
                    <!-- Denda -->
                    <div class="mb-2">
                ...
                <input type = "submit" name ="simpan" value ="Tambah" class = "btn btn-primary mb-2">
            </form>
        </div>
    </div>
</div>
